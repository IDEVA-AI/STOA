  ...
  if (inviteCode && inviteInfo && !inviteInfo.valid) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg p-6">
        <div className="card-editorial max-w-md w-full p-6 sm:p-8 lg:p-12 bg-surface text-center space-y-6">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg transition-colors duration-500 p-6">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 card-editorial overflow-hidden bg-surface transition-colors duration-500">
        ...
        {/* Right Side: Form */}
        <div className="p-6 sm:p-8 lg:p-20 flex flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <FormGroup
              ...
              labelAction={
                authMode === 'login' ? (
                  <button type="button" className="text-[10px] mono-label text-gold hover:underline" onClick={() => window.location.href = '/forgot-password'}>Esqueceu a senha?</button>
                ) : undefined
              }
            >
              <Input
